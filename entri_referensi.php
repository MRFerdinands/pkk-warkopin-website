                ...
                ?>
                  ...
                  <?php
                    ...
                    if(isset($_POST['search_menu'])){
                      $search_query = mysqli_real_escape_string($conn, $_POST['search_menu']);
                      $query_data_makanan = "SELECT * FROM tb_masakan WHERE stok > 0 AND nama_masakan LIKE '%$search_query%' ORDER BY id_masakan DESC";
                    } else {
                    ...
                    while($r_dt_makanan = mysqli_fetch_array($sql_data_makanan)){
                      // Your existing code to display the menu
                    }
                  ?>
                <!--End Looping-->
              </ul>
